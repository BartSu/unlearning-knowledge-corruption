...
\begin{frame}{Audit results}
    ...
    \begin{center}
        \Large
        All three layers: $R^2 > 0$ and MAE beats LOO-mean baseline
    \end{center}
    \vspace{0.2em}
    \begin{center}
        \normalsize
        But at $n=10$ CI is wide, L1 / L3 lower bounds cross 0 $\Rightarrow$ \alert{rank-level screening signal}; $n=100$ needed to tighten.
    \end{center}
