...
\begin{frame}{Audit results}
    ...
    \begin{center}
        \Large
        Rank correlation $\rho \approx \textbf{0.62}$ on all three layers
    \end{center}
    \vspace{0.3em}
    \begin{center}
        \normalsize
        The worst L1 forget set (\texttt{storm}) is correctly predicted.
    \end{center}

    \vspace{0.4em}
    \footnotesize\centering\itshape
    $n=10$, single observation; robustness to larger $n$ and other unlearners yet to be validated.
\end{frame}
