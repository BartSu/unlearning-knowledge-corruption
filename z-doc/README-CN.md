# Three-Layer View of Knowledge Corruption in LLM Unlearning —— 为什么要审计 forget set，而不是每次都 unlearn
...
## 5. 第二幕：与其每次 unlearn，不如审计 forget set
...
* **Title**（工作名）：*A Three-Layer View of Knowledge Corruption in LLM
  Unlearning, and Why You Should Audit Before You Forget.*
